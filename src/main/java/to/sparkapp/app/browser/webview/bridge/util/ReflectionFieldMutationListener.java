package to.sparkapp.app.browser.webview.bridge.util;
...
public class ReflectionFieldMutationListener {
    ...
    private Consumer<Object> onMutate;

    public ReflectionFieldMutationListener(@NonNull Field field, Object instance) {
        this(field, instance != null ? new WeakReference<>(instance) : null);
    }

    public ReflectionFieldMutationListener(@NonNull Field field, WeakReference<Object> instance) {
        this.field = field;
        this.$inst = instance;
        this.lastHash = 0;
    ...
    public <T> void onMutate(final Consumer<T> consumer) {
