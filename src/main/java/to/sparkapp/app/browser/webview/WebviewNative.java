...
interface WebviewNative extends Library {
    ...
    private static WebviewNative runSetup() {
        ...
        switch (Platform.osDistribution) {
            case LINUX: {
                if (LinuxLibC.isGNU()) {
                    libraries = new String[] {
                            "/webview/natives/" + Platform.archTarget + "/linux/gnu/libwebview.so"
                    };
                } else {
                    libraries = new String[] {
                            "/webview/natives/" + Platform.archTarget + "/linux/musl/libwebview.so"
                    };
                }
                break;
            }
            ...
            case MACOS: {
                libraries = new String[] {
                        "/webview/natives/" + Platform.archTarget + "/macos/libwebview.dylib"
                };
                break;
            }
            ...
            case WINDOWS_NT: {
                libraries = new String[] {
//                        "/webview/natives/" + Platform.archTarget + "/windows_nt/WebView2Loader.dll",
                        "/webview/natives/" + Platform.archTarget + "/windows_nt/webview.dll"
                };
                break;
            }
